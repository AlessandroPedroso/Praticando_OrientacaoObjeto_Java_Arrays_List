...
/*Main é um metado executavel em java*/
public static void main(String[] args) {
	...
	try {
		...
		/*PermitirAcesso permitirAcesso = new Secretario(login,senha)*/;/*Diretamento com o objeto*/
		...
		*/
		...
		/* aluno1 é referenciado para o objeto aluno */
		...
		*/
		/* int idadeAluno = Integer.parseInt(idade); */
		...
		*/
		for (int pos = 1; pos <=1; pos++) {
			...
			String nomeDisiciplina = JOptionPane.showInputDialog("Nome da disciplina "+pos+"?");
			String notaDisciplina = JOptionPane.showInputDialog("Nota da disciplina "+pos+"?");
			
			Disciplina disciplina = new Disciplina();
			disciplina.setDisciplina(nomeDisiciplina);
		...
		for (Aluno aluno : alunos) { /*separei em listas*/
			...
			if (aluno.getAlunoAprovado2() == StatusAluno.APROVADO) {
			...
			System.out.println("------------------Listas dos Recuperaçao------------------");
		...
		for (int posicao = 0; posicao < e.getStackTrace().length; posicao++ ) {
			...
			saida.append("\n Class erro: " + e.getClass().getName());
			
			System.out.println("Classe de erro: " + e.getStackTrace()[posicao].getClassName());
			System.out.println("Método de erro: " + e.getStackTrace()[posicao].getMethodName());
			System.out.println("Linha de erro: " + e.getStackTrace()[posicao].getLineNumber());
			System.out.println("Classe erro: " + e.getClass().getName());
